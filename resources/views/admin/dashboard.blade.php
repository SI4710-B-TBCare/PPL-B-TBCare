<x-app-layout>
    ...
    <section class="row">
        ...
        <x-card-sum text="Daftar Fasilitas Kesehatan" value="{{ App\Models\FasilitasKesehatan::count() }}"
            icon="th-list" color="warning" />
        <x-card-sum text="Daftar Artikel" value="{{ App\Models\Artikel::count() }}" icon="th-list" color="danger" />
    </section>
    ...
    {{-- PBI #22 - Sebaran Wilayah Pengguna --}}
    <section class="row">
        <div class="col-md-6">
            <x-card>
                <x-slot name="title">
                ...
                <table class="table table-hover border">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="2" class="text-center">Belum ada data wilayah</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Grafik Sebaran Wilayah</h6>
                </div>
                <div class="card-body">
